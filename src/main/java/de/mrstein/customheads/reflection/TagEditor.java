...
//    public static HashMap<String, List<String>> getAllTags(ItemStack itemStack) {
//        HashMap<String, List<String>> result = new HashMap<>();
//        try {
//            Object itemCopy = getAsMNSCopy(itemStack);
//            Object itemTag = itemCopy.getClass().getMethod("getTag").invoke(itemCopy);
//            Object nbtCompound = itemTag.getClass().getMethod("getCompound", String.class).invoke(itemTag, "NBTEditorTags");
//            for (String listArray : (Set<String>) nbtCompound.getClass().getMethod("c").invoke(nbtCompound)) {
//                Object nbtTagList = nbtCompound.getClass().getMethod("getList", String.class, int.class).invoke(nbtCompound, listArray, 8);
//                List<String> tags = new ArrayList<>();
//                for(int i = 0; i < (int) nbtTagList.getClass().getMethod("size").invoke(nbtTagList); i++) {
//                    tags.add((String) nbtTagList.getClass().getMethod("getString", int.class).invoke(nbtTagList, i));
//                }
//                result.put(listArray, tags);
//            }
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
...
//    }
    ...
    public ItemStack addTags(ItemStack itemStack, String... tags) {
        ...
        itemStack = setTags(itemStack, prevTags);
        return itemStack;
    }
    ...
    public ItemStack addTags(ItemStack itemStack, List<String> tags) {
        ...
        itemStack = setTags(itemStack, tags);
        return itemStack;
    }
    ...
    public ItemStack copyOf(ItemStack of, ItemStack to) {
        return setTags(to, getTags(of));
    }
