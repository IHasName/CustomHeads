...
public class GameProfileBuilder {
    ...
    public static String gameProfileToString(GameProfile profile) { return gson.toJson(profile); }

    public static GameProfile gameProfileFromString(String string) { return gson.fromJson(string, GameProfile.class); }
    ...
    public static class CachedProfile {
        ...
        public CachedProfile(GameProfile profile) { this.profile = profile; }

        public boolean isValid() { return cacheTime < 0 || (System.currentTimeMillis() - timestamp) < cacheTime; }
    }
