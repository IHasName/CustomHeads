...
public class ReflectionConstructorCollection {
    ...
    public static final ConstructorWrapper<?> PACKET_PLAYOUT_CHAT_V1161 = new ConstructorWrapper<>(Version.V1_16_R1, null, ReflectionClassCollection.PACKET_PLAYOUT_CHAT, ReflectionClassCollection.ICHAT_BASE_COMPONENT.resolve(), ReflectionClassCollection.CHAT_MESSAGE_TYPE.resolve(), UUID.class);
